% [0 1 2 3],
%     1.5 2.5
load('resultsMAT/Polar_QPSK_designSNR2_N4096_K2048_L1_R12_1e4_CRC8.mat');
%                  Polar_QPSK_designSNR2_N4096_K2730_L8_R12_1e4_CRC8
EbNo = results.EbNo;
FER = results.FER;
BER = results.BER;

load('HeshResults/Polar_N4096_K2048_R12_L1_1.50dB_1e3_CRC8.mat');
...
load('HeshResults/Polar_N4096_K2048_R12_L1_2.50dB_1e3_CRC8.mat');
% 
% Results.EbNo = [a.EbNo  ];
% Results.FER =  [a.FER   ];
% Results.BER =  [a.BER   ];
...
filename = sprintf('HeshResults/Polar_N4096_L1_R12');
