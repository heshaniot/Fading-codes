function PCparams= initPC(N,K,L,Ec,N0,designSNRdB,PCparams,silentflag) %designSNRdB optional
%
...
if nargin==4 %Normalize noise-power-spectral-density, when not supplied: --- N0/2=1 (default)
    N0=2;
    designSNRdB=0;
    PCparams = struct;
    silentflag=0;
