function plotPC(N,K,L,EbN0dBrange,designSNRdB,MCsize,label,verbose_output_flag) %designSNRdB is optional
...
%         y = txvec + channelNoise;
         y = H.*txvec./(H.*transpose(H'))+ channelNoise;
...
filename = sprintf('FADING_RESULTS/N128/Polar_N%d_K%d_R%d_L%d_%.2fdB_1e%d_CRC8.mat',N,K,label,L,EbN0dBrange,log10(MCsize));
