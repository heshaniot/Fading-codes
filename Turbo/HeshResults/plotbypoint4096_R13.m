function plotbypoint4096_R13

clear all;

EbNo_vec =  [0 0.25  0.5 1 1.5 ];
 iter =     [2 2     3   3 5];
...
%     LDPC_N2040_K1360_R23_QAM_OMS_Iter40_1e4_EbNo0.00_point1
    str = sprintf('Turbo_R13_QAM_N4044_K1344_Iter6_%.2fdB_1e%d.mat',EbNo_vec(point),iter(point));
...
save('Concat/N4096_R13','Results1')
subplot(211)
% hold on
semilogy(EbNo,BLER);
hold on;
