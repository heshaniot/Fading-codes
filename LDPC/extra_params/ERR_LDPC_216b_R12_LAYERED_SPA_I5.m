function ERR_LDPC_216b_R12_LAYERED_SPA_I5(RunID) 

  % == LDPC SETTINGS ====================================
 RunID=0;
  TxRx.Sim.name = 'ERR_LDPC_216b_R12_LAYERED_SPA_I5';
  ...
  load('codes/LDPC_11nD2_216b_R12.mat'); % load code
  
  % == EXECUTE SIMULATION ===============================  
  
  sim_LDPC(RunID,TxRx,LDPC)
  title('LDPC 216b R1/2 LAYERED SPA I5')
