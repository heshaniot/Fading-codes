function ldpc2048_R13(ebn) 
%  LDPC_heshani_504b_R23
  % == LDPC SETTINGS ====================================
  RunID=0;
  TxRx.Sim.name = 'LDPC_heshani_2048b_R13';
...
%   snr =1;
  ...
  load('codes/LDPC_heshani_2040b_R13.mat'); % load code
  
  % == EXECUTE SIMULATION ===============================  
  label.folder = 'FADING_RESULTS/N2048';
  label.number = no;
  label.rate = 13 ;
  sim_LDPC_QAM_RayleighFading_point_lowRates_parr(RunID,TxRx,LDPC,label) 
