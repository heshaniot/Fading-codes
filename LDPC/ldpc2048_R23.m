function ldpc2048_R23(ebn) 
%  LDPC_heshani_504b_R23
  % == LDPC SETTINGS ====================================
  RunID=0;
  TxRx.Sim.name = 'LDPC_heshani_2048b_R23';
...
%   snr =1;
  ...
  load('codes/LDPC_heshani_2040b_R23.mat'); % load code
  
  % == EXECUTE SIMULATION ===============================  
  label.folder = 'FADING_RESULTS/N2048';
  label.number = no;
  label.rate = 23;
   sim_LDPC_QAM_RayleighFading_parr(RunID,TxRx,LDPC,label) 
